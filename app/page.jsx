    ...
    const FEATURES = [
      {
        ...
        description:
          "Price Pulsex`x    extracts prices in seconds, handling JavaScript and dynamic content",
      },
      {
        icon: Shield,
        ...
        <section className="py-20 px-4">
            <div className="max-w-7xl mx-auto text-center">
                ...
                <div className="inline-flex items-center gap-2 bg-orange-100 text-orange-700 px-6 py-2 rounded-full text-sm font-medium mb-6">
                    Made with ❤️ by Puneet Kumar Singh
                </div>
                ...
                <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto">
                    Track prices from any e-commerce site. Get instant alerts when prices drop. Save money effortlessly with Price Pulse.
                </p>
                ...
                {products.length === 0 && (
                    <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto mt-16">
                        {FEATURES.map(({ icon: Icon, title, description }) => (
                            ...
                            >
                                <div className="w-12 h-12 bg-border-100 rounded-lg flex items-center justify-center mb-4 mx-auto">
