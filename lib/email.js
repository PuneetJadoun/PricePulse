            ...
            <div style="background: #ffffff; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 10px 10px;">
              ...
              ${
                ...
                <div style="text-align: center; margin-bottom: 20px;">
                  <img src="https://images.weserv.nl/?url=${encodeURIComponent(product.image_url)}" alt="${product.name}" style="max-width: 200px; height: auto; border-radius: 8px; border: 1px solid #e5e7eb;">
                </div>
              `
                  : ""
              }
